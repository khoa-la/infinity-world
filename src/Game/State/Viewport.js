...
export default class Viewport {
  ...
  setPointerLock() {
    ...
    this.pointerLock.toggle = () => {
      if (this.pointerLock.active) this.pointerLock.deactivate();
      else this.pointerLock.activate();
    };
  ...
  setFullscreen() {
    ...
    this.fullscreen.toggle = () => {
      if (this.fullscreen.active) this.fullscreen.deactivate();
      else this.fullscreen.activate();
    };
